module.exports = {
  ...
  options: {
    ...
    limit: {
      describe: 'number of S3 operations to process concurrently. Higher values are faster but may cause timeouts or memory problems.',
      'default': 20
    },
    dirlimit: {
      describe: 'number of local directories operations to process concurrently during PUT operations. Higher values are faster but may cause timeouts or memory problems.',
      'default': 20
    }
  },
  examples: [
